...
const DomDisplay = (() => {
  const displayList = (list, listID) => {
    ...
    Array.from(document.getElementsByClassName('delete-btn')).forEach(
      button => {
        button.addEventListener('click', _interface__WEBPACK_IMPORTED_MODULE_1__["default"].deleteButton)
      }
    )
    Array.from(document.getElementsByClassName('select-btn')).forEach(
      button => {
        button.addEventListener('click', _interface__WEBPACK_IMPORTED_MODULE_1__["default"].selectButton)
      }
    )
    Array.from(document.getElementsByClassName('edit-btn')).forEach(
      button => {
        button.addEventListener('click', _interface__WEBPACK_IMPORTED_MODULE_1__["default"].editButton)
      }
    )
    Array.from(document.getElementsByClassName('completed-checkbox')).forEach(
      button => {
        button.addEventListener('click', _interface__WEBPACK_IMPORTED_MODULE_1__["default"].completeButton)
      }
    )
  }
  const refresh = (activeProject = 0) => {
    displayList(_project__WEBPACK_IMPORTED_MODULE_0__["default"].list, 'project-list')
    displayList(_project__WEBPACK_IMPORTED_MODULE_0__["default"].list[activeProject].listItems(), 'todo-list')
    ...
    _project__WEBPACK_IMPORTED_MODULE_0__["default"].save()
...
/* harmony import */ var _dom_display__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom_display */ "./src/dom_display.js");
...
if (projectList) {
  _project__WEBPACK_IMPORTED_MODULE_1__["default"].load()
} else {
  const test = Object(_item__WEBPACK_IMPORTED_MODULE_0__["Item"])('Add items to your todo list', new Date('2020-02-01'))

  const test2 = Object(_item__WEBPACK_IMPORTED_MODULE_0__["Item"])('Add another project', new Date('2020-03-01'))

  const test3 = Object(_item__WEBPACK_IMPORTED_MODULE_0__["Item"])('test', new Date('2020-04-01'))

  const defaultProject = _project__WEBPACK_IMPORTED_MODULE_1__["default"].create('Default Project')

  defaultProject.addItems([test, test2, test3])

  _project__WEBPACK_IMPORTED_MODULE_1__["default"].create('Test project')
}
_dom_display__WEBPACK_IMPORTED_MODULE_2__["default"].refresh()

document
  .getElementById('new-project-btn')
  .addEventListener('click', _interface__WEBPACK_IMPORTED_MODULE_3__["default"].newButton)

document.getElementById('new-todo-btn').addEventListener('click', _interface__WEBPACK_IMPORTED_MODULE_3__["default"].newButton)
...
const Interface = (() => {
  ...
  const newButton = event => {
    ...
    if (event.target.id === 'new-project-btn') {
      ...
      _project__WEBPACK_IMPORTED_MODULE_0__["default"].create(projectName)
      _dom_display__WEBPACK_IMPORTED_MODULE_2__["default"].refresh(projectIndex)
      ...
      const newTodo = Object(_item__WEBPACK_IMPORTED_MODULE_1__["Item"])(name, date, priority)
      _project__WEBPACK_IMPORTED_MODULE_0__["default"].list[projectIndex].addItem(newTodo)
      _dom_display__WEBPACK_IMPORTED_MODULE_2__["default"].refresh(projectIndex)
    }
  }
  ...
  const deleteButton = event => {
    ...
    if (event.target.classList.contains('del-project-list')) {
      ...
      _project__WEBPACK_IMPORTED_MODULE_0__["default"].removeListAt(liIndex)
      _dom_display__WEBPACK_IMPORTED_MODULE_2__["default"].refresh(liProjectIndex)
    } else if (event.target.classList.contains('del-todo-list')) {
      // Find the active list
      const liItemIndex = getIndex(event.target)
      _project__WEBPACK_IMPORTED_MODULE_0__["default"].list[liProjectIndex].removeItemAt(liItemIndex)
      _dom_display__WEBPACK_IMPORTED_MODULE_2__["default"].refresh(liProjectIndex)
    }
  }
  ...
  const saveName = event => {
    ...
    _project__WEBPACK_IMPORTED_MODULE_0__["default"].list[projectIndex].setName(projectName)
    _dom_display__WEBPACK_IMPORTED_MODULE_2__["default"].refresh(projectIndex)
  }
  ...
  const saveDetails = () => {
    ...
    const item = _project__WEBPACK_IMPORTED_MODULE_0__["default"].list[projectIndex].listItems()[itemNum]
  ...
  const editButton = event => {
    ...
    if (button.classList.contains('edit-project-list')) {
      ...
      const projectName = _project__WEBPACK_IMPORTED_MODULE_0__["default"].list[liIndex].getName()
      ...
      const todoItem = _project__WEBPACK_IMPORTED_MODULE_0__["default"].list[liProjectIndex].listItems()[liIndex]
  ...
  const selectButton = event => {
    ...
    _dom_display__WEBPACK_IMPORTED_MODULE_2__["default"].displayList(_project__WEBPACK_IMPORTED_MODULE_0__["default"].list[liIndex].listItems(), 'todo-list')
  }
  const completeButton = (event) => {
    const liIndex = getIndex(event.target.parentElement)
    const projectIndex = getActiveList()
    _project__WEBPACK_IMPORTED_MODULE_0__["default"].list[projectIndex].listItems()[liIndex].toggleComplete()
    _project__WEBPACK_IMPORTED_MODULE_0__["default"].save()
  }
